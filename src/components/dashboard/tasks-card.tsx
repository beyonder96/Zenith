...
export function TasksCard() {
  ...
  const pendingTasks = projects.filter((p) => !p.completed);

  return (
    <Link href="/projects" className="block transition-transform hover:scale-[1.02]">
        ...
        <CardContent>
          {!isClient ? (
            ...
            <>
              ...
              <p className="text-xs text-muted-foreground">tarefas a fazer</p>
            </>
          ) : (
